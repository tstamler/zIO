...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 16384 &
...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 32768 &
...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 65536 &
...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 131072 &
...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 262144 &
...
./echoserver_linux 0 8000 1 ./echoserver.conf 128 $((512*1024)) &

ssh zio_ae@10.0.0.1 "cd zIO/benchmarks/micro_rpc_cpy; timeout 30 ./testclient_linux 10.0.0.6 8000 $CLIENT_THREADS ./testclient.conf $((512*1024)) >> results/size_sweep/512KB.dat"

./echoserver_linux 0 8000 1 ./echoserver.conf 128 $((1024*1024)) &

ssh zio_ae@10.0.0.1 "cd zIO/benchmarks/micro_rpc_cpy; timeout 30 ./testclient_linux 10.0.0.6 8000 $CLIENT_THREADS ./testclient.conf $((1024*1024)) >> results/size_sweep/1024KB.dat"

# REMOVE BEGIN
echo "Processing..."
ssh zio_ae@10.0.0.1 "cd zIO/benchmarks/micro_rpc_cpy/results/size_sweep; reviewer_B/process.sh"
...
LD_PRELOAD=../../tas/lib/copy_interpose.so ./echoserver_linux 5 8000 1 ./echoserver.conf 128 $((512*1024)) &

ssh zio_ae@10.0.0.1 "cd zIO/benchmarks/micro_rpc_cpy; timeout 30 ./testclient_linux 10.0.0.6 8000 $CLIENT_THREADS ./testclient.conf $((512*1024)) >> results/size_sweep/512KB_zio.dat"

LD_PRELOAD=../../tas/lib/copy_interpose.so ./echoserver_linux 5 8000 1 ./echoserver.conf 128 $((1024*1024)) &

ssh zio_ae@10.0.0.1 "cd zIO/benchmarks/micro_rpc_cpy; timeout 30 ./testclient_linux 10.0.0.6 8000 $CLIENT_THREADS ./testclient.conf $((1024*1024)) >> results/size_sweep/1024KB_zio.dat"
