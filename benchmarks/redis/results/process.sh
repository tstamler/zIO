...
echo "4KB: $( awk -F'"' '{print $4}' 4KB_zio.dat ) req/s" >> final.dat

echo "16KB: $( awk -F'"' '{print $4}' 16KB_zio.dat ) req/s" >> final.dat

echo "64KB: $( awk -F'"' '{print $4}' 64KB_zio.dat ) req/s" >> final.dat

echo "128KB: $( awk -F'"' '{print $4}' 128KB_zio.dat ) req/s" >> final.dat

echo "512KB: $( awk -F'"' '{print $4}' 512KB_zio.dat ) req/s" >> final.dat
