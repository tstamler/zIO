...
#LD_PRELOAD=$SRC_ROOT/shim/libshim/libshim.so MLFS=1 MLFS_PROFILE=1 $@
LD_PRELOAD=/home/tstamler/stratas_dev/tas/lib/libtas_interpose.so MLFS=1 valgrind -v /home/tstamler/stratas_dev/strata/bench/redis-3.2.8/src/redis-server.mlfs ../redis_mlfs.conf  
